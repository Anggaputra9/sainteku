...
<template x-teleport="#modal-root">
    ...
    class="app-modal-overlay fixed inset-0 flex items-center justify-center p-3 sm:p-6 overflow-y-auto backdrop-blur-sm bg-gray-900/40 relative"
    ...
    @if(empty(Auth::user()->signature))
        {{-- Overlay TTD di dalam modal detail (tanpa teleport, selalu di atas panel) --}}
        <div x-show="openSignature"
            class="absolute inset-0 z-[1000] flex items-center justify-center p-4 sm:p-6 bg-gray-900/70 backdrop-blur-sm"
            ...
            <div @click.away="openSignature = false"
                ...
                <div class="shrink-0 bg-blue-600 px-5 sm:px-6 py-3 sm:py-4 flex justify-between items-center dark:bg-blue-700">
