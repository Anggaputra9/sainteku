...
<template x-teleport="#modal-root">
    ...
    <div
        ...
        @if(empty(Auth::user()->signature))
            {{-- Overlay TTD di dalam panel modal (relative parent) --}}
            <div x-show="openSignature"
                class="absolute inset-0 z-[1000] flex items-center justify-center p-4 sm:p-6 bg-gray-900/70 backdrop-blur-sm rounded-2xl"
