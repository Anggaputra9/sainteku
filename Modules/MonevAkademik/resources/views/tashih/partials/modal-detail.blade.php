                                            ...
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p
                                                        ...
                                                        Tambahkan tanda tangan digital di
                                                        <a href="{{ route('profile.edit') }}#tanda-tangan"
                                                            class="font-bold underline underline-offset-2 hover:text-orange-900 dark:hover:text-orange-300">
                                                            halaman Profile
                                                        </a>
                                                        terlebih dahulu sebelum menyetujui pengajuan.</p>
                                                </div>
                                            </div>
                                        @else
                                            <div
            ...
            <div
                ...
                <div class="flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex flex-wrap items-center gap-2 sm:gap-3 sm:justify-end">
                        ...
                        @if(empty(Auth::user()->signature))
                            <a href="{{ route('profile.edit') }}#tanda-tangan" x-show="canReviewProposal" x-cloak
                                class="inline-flex items-center gap-2 rounded-xl bg-orange-500 px-5 py-2.5 text-sm font-bold text-white shadow-md shadow-orange-500/20 hover:bg-orange-600 hover:shadow-lg focus:ring-4 focus:ring-orange-500/30 transition-all">
                                <i class="fas fa-pen-nib"></i> Tambah Tanda Tangan
                            </a>
                        @else
                            <button type="button" x-show="canReviewProposal" x-cloak
