        ...
        <div class="space-y-6">
            ...
            <div
                ...
                <div class="mb-6 space-y-4">
                    {{-- Tombol Back (Hanya muncul saat lihat arsip) --}}
                    <template x-if="viewMode === 'proposals'">
                        {{-- Bungkus pakai flex justify-end biar tombolnya kedorong mentok ke kanan --}}
                ...
                <div class="flex-1">
                    ...
                    {{-- MODE 2: LIST PAKET SOAL (PROPOSALS) --}}
                                    ...
                                    <div>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                {{-- Versi Mobile: Cuma muncul di layar kecil, ambil kata pertama aja --}}
                                                <span class="sm:hidden"
                                                    x-text="prop.creator ? prop.creator.name.split(' ')[0] : '-'"></span>

                                                {{-- Versi Desktop: Sembunyi di HP, muncul di layar agak gedean
                                                (Tablet/Laptop) --}}
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('bankSoalApp', () => ({
                ...
                async fetchCourses() {
                    ...
                    let url = new URL(`{{ url('monev-akademik/tashih/api/approved-courses') }}`);
                ...
                async openCourseProposals(course) {
                    ...
                    try {
                        ...
                        const apiUrl = `{{ url('monev-akademik/bank-soal/api/proposals') }}/${course.id}`;
