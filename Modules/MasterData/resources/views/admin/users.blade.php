...
@section('content')
    <div class="space-y-6" x-data="{
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <form method="GET" action="{{ route('masterdata.admin.users.index') }}" class="grid grid-cols-1 md:grid-cols-4 xl:grid-cols-8 gap-3 items-end">
                    ...
                    <div class="md:col-span-2 xl:col-span-2 flex gap-2">
                        ...
                        <a href="{{ route('masterdata.admin.users.index') }}" class="flex-1 inline-flex justify-center rounded-xl bg-gray-200 px-5 py-2.5 text-sm font-bold text-gray-700 hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-200">Reset</a>
                    </div>
                </form>
            </div>
                                ...
                                <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-700/30">
                                    ...
                                    <td class="px-6 py-4 text-center whitespace-nowrap">
                                        ...
                                        <div class="flex gap-2 justify-center">
                                            <button @click="$dispatch('open-detail-modal', {{ \Illuminate\Support\Js::from($editPayload) }})"
