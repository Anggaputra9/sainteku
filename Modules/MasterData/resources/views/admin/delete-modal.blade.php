    ...
    <div @click.away="openDelete = false"
        ...
        <div class="border-b border-gray-200 bg-white px-4 py-3 sm:px-6 sm:py-4 dark:bg-[#1e293b] dark:border-gray-700">
            <div class="flex min-w-0 items-center gap-2 sm:gap-3">
                <div
                    class="flex h-8 w-8 sm:h-9 sm:w-9 shrink-0 items-center justify-center rounded-xl border border-red-100 bg-red-50 dark:border-red-800/50 dark:bg-red-900/30">
                    <i class="fa-solid fa-triangle-exclamation text-sm text-red-600 dark:text-red-400 sm:text-base"></i>
                </div>
                <div class="min-w-0 leading-tight">
                    <h3 class="truncate whitespace-nowrap text-sm font-bold text-gray-900 dark:text-gray-100 sm:text-lg">
                        Konfirmasi Hapus
                    </h3>
