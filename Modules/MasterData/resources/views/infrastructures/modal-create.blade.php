<div x-data="{ openCreate: false }"
    ...
    <div @click.away="openCreate = false" x-show="openCreate"
        ...
        <form action="{{ route('masterdata.infrastructures.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="description" required
                        ...
                        placeholder="Contoh: Ruang Rapat Utama / Proyektor Epson" value="{{ old('description') }}">
                </div>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="number" name="quantity" required min="1"
                            class="w-full rounded-lg border-0 px-4 py-2.5 text-gray-900 ring-1 ring-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 dark:bg-gray-900 dark:text-white dark:ring-gray-600"
                            placeholder="Contoh: 10" value="{{ old('quantity', 1) }}">
                    </div>
                </div>
            </div>
