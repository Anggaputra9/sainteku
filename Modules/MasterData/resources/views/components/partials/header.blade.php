<header
    ...
    <div class="mx-auto flex max-w-screen-2xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-5">
            ...
            {{-- Tombol Hamburger (Desktop - xl ke atas) --}}
            <button @click.stop="$store.sidebar.toggleExpanded()"
                class="hidden xl:flex group h-10 w-10 items-center justify-center rounded-xl border border-gray-200 bg-white shadow-sm transition-all hover:bg-gray-50 active:scale-95 dark:border-gray-800 dark:bg-gray-900 dark:hover:bg-gray-800">
            ...
            {{-- Tombol Hamburger (Mobile - di bawah xl) --}}
            <button @click.stop="$store.sidebar.toggleMobileOpen()"
                class="flex xl:hidden group h-10 w-10 items-center justify-center rounded-xl border border-gray-200 bg-white shadow-sm transition-all hover:bg-gray-50 active:scale-95 dark:border-gray-800 dark:bg-gray-900 dark:hover:bg-gray-800">
                <svg class="h-5 w-5 text-gray-600 transition-colors group-hover:text-indigo-600 dark:text-gray-400 dark:group-hover:text-white"
                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
                </svg>
        ...
        <div class="flex items-center gap-3">
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-100"
                    ...
                    class="absolute right-0 mt-3 w-56 origin-top-right rounded-2xl border border-gray-100 bg-white p-2 shadow-xl dark:border-gray-700 dark:bg-gray-800 z-50">
