<template x-teleport="#modal-root">
    <div x-data="{ openDelete: false, url: '', periodName: '' }"
        @open-delete-modal.window="openDelete = true; url = $event.detail.url; periodName = $event.detail.name"
        x-show="openDelete"
        ...
        <div @click.away="openDelete = false"
            ...
            <div class="border-b border-gray-200 bg-white px-4 py-3 sm:px-6 sm:py-4 dark:bg-[#1e293b] dark:border-gray-700">
                <div class="flex min-w-0 items-center gap-2 sm:gap-3">
                    ...
                    <div class="min-w-0 leading-tight">
                        ...
                        <p class="truncate text-xs text-gray-500 dark:text-gray-400 sm:text-sm" x-text="periodName"></p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 space-y-5 bg-slate-50 dark:bg-[#0f172a]">
                <p class="text-sm text-gray-600 dark:text-gray-300">
                    Apakah Anda yakin ingin menghapus periode <span class="font-bold text-gray-900 dark:text-white" x-text="periodName"></span>? Tindakan ini tidak dapat dibatalkan.
                </p>
