            ...
            <div class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $totalRoles ?? '0' }}</p>
                    </div>
                </div>
            </div>
            <div class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $totalUnits ?? '0' }}</p>
                    </div>
                </div>
            </div>
            <div class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $totalCurricula ?? '0' }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="group relative overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-200 transition-all hover:shadow-lg hover:ring-blue-200 dark:bg-gray-800 dark:ring-gray-700 dark:hover:ring-blue-700">
                ...
                <div class="p-6">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('masterdata.admin.users.index') }}" class="inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400">
                            Kelola Pengguna
            ...
            <div class="group relative overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-200 transition-all hover:shadow-lg hover:ring-green-200 dark:bg-gray-800 dark:ring-gray-700 dark:hover:ring-green-700">
                <div class="p-6">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('masterdata.roles.index') }}" class="inline-flex items-center text-sm font-medium text-green-600 hover:text-green-700 dark:text-green-400">
                            Kelola Role
                            <svg class="ml-1 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
            ...
            <div class="group relative overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-200 transition-all hover:shadow-lg hover:ring-purple-200 dark:bg-gray-800 dark:ring-gray-700 dark:hover:ring-purple-700">
                <div class="p-6">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('masterdata.units.index') }}" class="inline-flex items-center text-sm font-medium text-purple-600 hover:text-purple-700 dark:text-purple-400">
                            Kelola Unit
                            <svg class="ml-1 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
            ...
            <div class="group relative overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-200 transition-all hover:shadow-lg hover:ring-yellow-200 dark:bg-gray-800 dark:ring-gray-700 dark:hover:ring-yellow-700">
                <div class="p-6">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('masterdata.curricula.index') }}" class="inline-flex items-center text-sm font-medium text-yellow-600 hover:text-yellow-700 dark:text-yellow-400">
                            Kelola Kurikulum
                            <svg class="ml-1 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
            ...
            <div class="group relative overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-200 transition-all hover:shadow-lg hover:ring-red-200 dark:bg-gray-800 dark:ring-gray-700 dark:hover:ring-red-700">
                <div class="p-6">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('masterdata.categories.index') }}" class="inline-flex items-center text-sm font-medium text-red-600 hover:text-red-700 dark:text-red-400">
                            Kelola Kategori
                            <svg class="ml-1 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
            ...
            <div class="group relative overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-200 transition-all hover:shadow-lg dark:bg-gray-800 dark:ring-gray-700">
                <div class="p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ config('masterdata.name') }}</h3>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Versi {{ config('masterdata.version') ?? '1.0' }}</p>
