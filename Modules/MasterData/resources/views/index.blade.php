        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div
                ...
                <div class="p-6">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('masterdata.categories.index') }}"
            ...
            <div
                ...
                <div class="p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ config('masterdata.name') }}
                            </h3>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Versi
                                {{ config('masterdata.version') ?? '1.0' }}</p>
