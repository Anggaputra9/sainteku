...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a href="{{ route('admin.achievements.pending') }}"
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-amber-600 dark:text-amber-400">{{ $achievements->where('status','pending')->count() }}</p>
                    </div>
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-600 dark:text-green-400">{{ $achievements->where('status','approved')->count() }}</p>
                    </div>
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-red-600 dark:text-red-400">{{ $achievements->where('status','rejected')->count() }}</p>
                    </div>
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <a href="{{ route('admin.achievements.index', ['status' => 'pending']) }}"
            ...
            <a href="{{ route('admin.achievements.index', ['status' => 'approved']) }}"
            ...
            <a href="{{ route('admin.achievements.index', ['status' => 'rejected']) }}"
        ...
        <div class="flex flex-wrap items-center gap-4 bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="{{ route('admin.achievements.index', array_merge(request()->query(), ['tahun' => ''])) }}"
                ...
                <a href="{{ route('admin.achievements.index', array_merge(request()->query(), ['tahun' => $tahun])) }}"
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition">
                            ...
                            <td class="px-6 py-4 text-center align-top">
                                <span class="text-sm font-medium">
                                    {{ date('d/m/Y', strtotime($item->achievement_date)) }}
                                </span>
                            </td>
                            <td class="px-6 py-4 text-center align-top">
                                @php
