    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="p-6">
                        <table class="w-full">
                            ...
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                ...
                                <td class="py-3 text-sm text-gray-900 dark:text-white">{{ $achievement->judul }}</td>
                            </tr>
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                            ...
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                ...
                                <td class="py-3 text-sm text-gray-900 dark:text-white">
                                    ...
                                    {{ date('d F Y', strtotime($achievement->tanggal)) }}
                                </td>
                            </tr>
                ...
                {{-- Detail Khusus Berdasarkan Kategori --}}
                ...
                <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div class="p-6">
                        <table class="w-full">
                            @if($achievement->jenis_publikasi)
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                <td class="py-2 text-sm font-medium text-gray-500 dark:text-gray-400 w-1/3">Jenis Publikasi</td>
                                <td class="py-2 text-sm text-gray-900 dark:text-white">{{ ucfirst($achievement->jenis_publikasi) }}</td>
                            </tr>
                            @endif
                            @if($achievement->nama_jurnal)
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                <td class="py-2 text-sm font-medium text-gray-500 dark:text-gray-400">Nama Jurnal</td>
                                <td class="py-2 text-sm text-gray-900 dark:text-white">{{ $achievement->nama_jurnal }}</td>
                            </tr>
                            @endif
                            @if($achievement->volume)
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                <td class="py-2 text-sm font-medium text-gray-500 dark:text-gray-400">Volume</td>
                                <td class="py-2 text-sm text-gray-900 dark:text-white">{{ $achievement->volume }}</td>
                            </tr>
                            @endif
                            @if($achievement->nomor)
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                <td class="py-2 text-sm font-medium text-gray-500 dark:text-gray-400">Nomor</td>
                                <td class="py-2 text-sm text-gray-900 dark:text-white">{{ $achievement->nomor }}</td>
                            </tr>
                            @endif
                            @if($achievement->halaman)
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                <td class="py-2 text-sm font-medium text-gray-500 dark:text-gray-400">Halaman</td>
                                <td class="py-2 text-sm text-gray-900 dark:text-white">{{ $achievement->halaman }}</td>
                            </tr>
                            @endif
                            @if($achievement->issn)
                            <tr>
                                <td class="py-2 text-sm font-medium text-gray-500 dark:text-gray-400">ISSN</td>
                                <td class="py-2 text-sm text-gray-900 dark:text-white">{{ $achievement->issn }}</td>
                            </tr>
                            @endif
                        </table>
                    </div>
                ...
                <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div class="p-6">
                        <table class="w-full">
                            @if($achievement->nomor_pendaftaran)
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                <td class="py-2 text-sm font-medium text-gray-500 dark:text-gray-400 w-1/3">Nomor Pendaftaran</td>
                                <td class="py-2 text-sm text-gray-900 dark:text-white">{{ $achievement->nomor_pendaftaran }}</td>
                            </tr>
                            @endif
                            @if($achievement->status_hki)
                            <tr>
                                <td class="py-2 text-sm font-medium text-gray-500 dark:text-gray-400">Status HKI</td>
                                <td class="py-2 text-sm text-gray-900 dark:text-white">{{ $achievement->status_hki }}</td>
                            </tr>
                            @endif
                        </table>
                    </div>
                    ...
                    <div class="p-6">
                        <table class="w-full">
                            ...
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                ...
                                <td class="py-2 text-sm text-gray-900 dark:text-white">{{ $achievement->isbn }}</td>
                            </tr>
                            @endif
                            @if($achievement->penerbit)
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                <td class="py-2 text-sm font-medium text-gray-500 dark:text-gray-400">Penerbit</td>
                                <td class="py-2 text-sm text-gray-900 dark:text-white">{{ $achievement->penerbit }}</td>
                            </tr>
                            @endif
                            @if($achievement->jumlah_halaman)
                            <tr>
                                <td class="py-2 text-sm font-medium text-gray-500 dark:text-gray-400">Jumlah Halaman</td>
                                <td class="py-2 text-sm text-gray-900 dark:text-white">{{ $achievement->jumlah_halaman }}</td>
                            </tr>
                            @endif
                        </table>
                    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div class="p-6 space-y-3">
                        <a href="{{ route('dosen.repository.edit', $achievement->id) }}"
                        ...
                        <form method="POST" action="{{ route('dosen.repository.destroy', $achievement->id) }}"
