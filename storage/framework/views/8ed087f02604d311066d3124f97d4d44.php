<?php $__env->startSection('content'); ?>
  <div class="mb-8 flex items-center justify-between">
    <div>
      ...
      <p class="text-sm text-gray-500 dark:text-gray-400">Memperbarui informasi unit: <span class="font-semibold text-blue-600 dark:text-blue-400"><?php echo e($unit->unit_name); ?></span></p>
    </div>
  ...
  <div class="max-w-2xl rounded-xl bg-white p-8 shadow-sm ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
    <form action="<?php echo e(route('masterdata.units.update', $unit->id)); ?>" method="POST" class="space-y-6">
      <?php echo csrf_field(); ?>
      ...
      <div class="grid grid-cols-1 gap-6">
        <div>
          ...
          <input type="text" name="id" value="<?php echo e($unit->id); ?>" readonly 
        ...
        <div>
          ...
          <input type="text" name="unit_name" required
            ...
            value="<?php echo e(old('unit_name', $unit->unit_name)); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <input type="number" name="unit_type_id" 
            class="w-full rounded-lg border-0 px-4 py-2.5 text-gray-900 ring-1 ring-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 dark:bg-gray-900 dark:text-white dark:ring-gray-600" 
            value="<?php echo e(old('unit_type_id', $unit->unit_type_id)); ?>">
        </div>

        <div class="pt-2">
          <label class="relative inline-flex cursor-pointer items-center gap-3">
            <input type="checkbox" name="is_active" value="1" class="peer sr-only" <?php echo e($unit->is_active == '1' ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\kuliah\semester6\laravel\sainteku\Modules/MasterData\resources/views/units/edit.blade.php ENDPATH**/ ?>