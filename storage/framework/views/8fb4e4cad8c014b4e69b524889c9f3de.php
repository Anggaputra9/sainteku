            ...
            <div class="border-b border-gray-200 bg-white px-4 py-3 sm:px-6 sm:py-4 dark:bg-[#1e293b] dark:border-gray-700">
                <div class="flex min-w-0 items-center gap-2 sm:gap-3">
                    ...
                    <div class="min-w-0 leading-tight">
                        ...
                        <p class="truncate text-xs text-gray-500 dark:text-gray-400 sm:text-sm" x-text="unitName"></p>
                    </div>
                </div>
            </div>
...
</template><?php /**PATH /mnt/volume_sgp1_1781186006004/projects/sainteku/Modules/MasterData/resources/views/units/delete-modal.blade.php ENDPATH**/ ?>