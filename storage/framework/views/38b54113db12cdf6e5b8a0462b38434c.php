    ...
    <div @click.away="openDetail=false"
        ...
        <div class="shrink-0 flex items-center justify-between gap-3 border-t border-gray-200 bg-white px-6 py-4 dark:bg-[#1e293b] dark:border-gray-700">
            <div class="flex gap-2 flex-wrap">
                <form :action="`<?php echo e(route('settings.ai.index')); ?>/${detail.id}/test`" method="POST" class="inline">
                    <?php echo csrf_field(); ?>
                    <button type="submit"
                ...
                <form :action="`<?php echo e(route('settings.ai.index')); ?>/${detail.id}/set-default`" method="POST" class="inline">
                    <?php echo csrf_field(); ?>
                ...
                <form :action="`<?php echo e(route('settings.ai.index')); ?>/${detail.id}/reset-usage`" method="POST" class="inline">
                    <?php echo csrf_field(); ?>
                    <button type="submit"
            ...
            <div class="flex gap-2 flex-wrap">
                ...
                <form :action="`<?php echo e(route('settings.ai.index')); ?>/${detail.id}`" method="POST" class="inline"
...
<?php /**PATH C:\laragon\www\sainteku\resources\views/settings/ai/partials/_modal-detail.blade.php ENDPATH**/ ?>