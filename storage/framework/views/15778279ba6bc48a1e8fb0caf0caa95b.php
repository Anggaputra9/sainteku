                ...
                try {
                    ...
                    if (!response.ok) {
                        window.dispatchEvent(new CustomEvent('cpl-delete-failed', {
                            bubbles: true,
                            detail: { message: result.message || 'Gagal menghapus CPL.' },
                        }));
                        return;
                    }
                    ...
                    window.dispatchEvent(new CustomEvent('cpl-delete-failed', {
                        bubbles: true,
                        detail: { message: 'Terjadi kesalahan saat menghapus CPL.' },
                    }));
                } finally {
                    this.deleting = false;
                }
...
</script><?php /**PATH /mnt/volume_sgp1_1781186006004/projects/sainteku/Modules/MasterData/resources/views/units/cpl-delete-modal.blade.php ENDPATH**/ ?>