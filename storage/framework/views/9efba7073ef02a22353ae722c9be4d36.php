...
<div x-data="{ openCreate: false }" @open-create-modal.window="openCreate = true" x-show="openCreate"
    ...
    <div @click.away="openCreate = false" x-show="openCreate"
        ...
        <form action="<?php echo e(route('masterdata.courses.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-6 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="course_name" required placeholder="Contoh: Pemrograman Web" 
                        ...
                        class="w-full rounded-lg border-0 px-4 py-2.5 text-gray-900 ring-1 <?php $__errorArgs = ['course_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-red-500 <?php else: ?> ring-gray-300 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> focus:ring-2 focus:ring-blue-500 dark:bg-gray-900 dark:text-white">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select id="select_prodi" name="unit_id" required
                                class="w-full rounded-lg border-0 px-4 py-2.5 text-gray-900 ring-1 <?php $__errorArgs = ['unit_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-red-500 <?php else: ?> ring-gray-300 <?php unset($message);
...
async function fetchAndPopulateProdi(fakultasId, selectProdi, preselectedProdiId = null) {
    ...
    try {
        const url = `<?php echo e(route('masterdata.courses.api.prodis')); ?>?fakultas_id=${fakultasId}`;
...
function initializeProdiFilter() {
    ...
    const preselectedProdiId = '<?php echo e(old("unit_id")); ?>' || null;
...
<?php /**PATH E:\kuliah\semester6\laravel\sainteku\Modules/MasterData\resources/views/courses/modal-create.blade.php ENDPATH**/ ?>