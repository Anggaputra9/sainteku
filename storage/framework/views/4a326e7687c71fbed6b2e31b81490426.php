<?php $__env->startSection('content'); ?>
  <div class="mb-8 flex items-center justify-between">
    <div>
      ...
      <p class="text-sm text-gray-500 dark:text-gray-400">Memperbarui data pengguna: <span class="font-semibold text-blue-600 dark:text-blue-400"><?php echo e($user->name); ?></span></p>
    </div>
  ...
  <div class="rounded-xl bg-white p-8 shadow-sm ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
    <form action="<?php echo e(route('masterdata.admin.users.update', $user->id)); ?>" method="POST" class="space-y-8">
      <?php echo csrf_field(); ?>
      ...
      <div class="grid grid-cols-1 gap-x-8 gap-y-6 md:grid-cols-2">
        ...
        <div>
          ...
          <input type="text" class="w-full rounded-lg border-0 bg-gray-50 px-4 py-2.5 text-gray-500 ring-1 ring-gray-200 focus:ring-2 focus:ring-blue-500 dark:bg-gray-900/50 dark:text-gray-400 dark:ring-gray-700" 
            value="<?php echo e($user->id); ?>" disabled title="ID tidak dapat diubah">
...
unset($__errorArgs, $__bag); ?>" 
            placeholder="Contoh: Muhammad Angga" value="<?php echo e(old('name', $user->name)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
            placeholder="user@uinsaizu.ac.id" value="<?php echo e(old('email', $user->email)); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <input type="text" name="identity_id" 
            ...
            placeholder="Masukkan nomor identitas" value="<?php echo e(old('identity_id', $user->identity_id)); ?>">
        </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <select name="user_type" 
            ...
            <option value="admin" <?php echo e(old('user_type', $user->user_type) == 'admin' ? 'selected' : ''); ?>>Admin Sistem</option>
            <option value="staff" <?php echo e(old('user_type', $user->user_type) == 'staff' ? 'selected' : ''); ?>>Staff Pegawai</option>
        ...
        <div class="flex items-end pb-2">
          <label class="relative inline-flex cursor-pointer items-center gap-3">
            <input type="checkbox" name="is_active" value="1" class="peer sr-only" <?php echo e(old('is_active', $user->is_active) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\kuliah\semester6\laravel\sainteku\Modules/MasterData\resources/views/admin/edit.blade.php ENDPATH**/ ?>