    ...
    <div
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar relative bg-slate-50 dark:bg-gray-900"
            ...
            <form id="form-pengajuan" class="flex flex-col min-h-full"
                :action="isEditMode ? '<?php echo e(url('monev-akademik/tashih/update')); ?>/' + editUuid : '<?php echo e(route('monevakademik.tashih.store')); ?>'"
                            ...
                            <div>
                                ...
                                <select name="period_id"
                                    ...
                                    <?php $__currentLoopData = $periods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $period): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($period->id); ?>" <?php echo e($period->is_active ? 'selected' : ''); ?>>
                                            <?php echo e($period->name); ?> - <?php echo e($period->semester); ?>
...
</script><?php /**PATH E:\kuliah\semester6\laravel\sainteku\Modules/MonevAkademik\resources/views/tashih/partials/modal-create-workspace.blade.php ENDPATH**/ ?>