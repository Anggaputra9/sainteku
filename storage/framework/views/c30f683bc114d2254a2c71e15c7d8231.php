...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10" x-data="{ 
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-wrap items-center gap-2 mb-2">
            ...
            <a href="<?php echo e(request()->url()); ?>?status=pending" 
            ...
            <a href="<?php echo e(request()->url()); ?>?status=approved" 
            ...
            <a href="<?php echo e(request()->url()); ?>?status=rejected" 
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        <?php $__empty_1 = true; $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition">
                                <td class="px-6 py-4">
                                    <div class="font-bold text-gray-900 dark:text-white"><?php echo e($doc->document_id); ?></div>
                                    <div class="text-sm font-medium text-gray-700 dark:text-gray-200"><?php echo e($doc->document_title); ?></div>
                                    <div class="text-xs text-gray-400 mt-1">Oleh: <?php echo e($doc->creator->name ?? 'Sistem'); ?></div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="font-medium text-indigo-600 dark:text-indigo-400"><?php echo e($doc->unit->unit_name ?? '-'); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e($doc->type->description ?? '-'); ?></div>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    ...
                                    ?>
                                    <span class="inline-flex rounded-full px-2.5 py-0.5 text-xs font-semibold <?php echo e($statusColor); ?>">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <a href="<?php echo e(route('DocumentRepository.download', $doc->id)); ?>" target="_blank"
                                        ...
                                        <?php if($doc->status != 3 && Auth::user()->hasPermission(1, 'A')): ?>
                                        <button 
                                            @click="openReview = true; reviewUrl = '<?php echo e(route('DocumentRepository.review', $doc->id)); ?>'; docTitle = '<?php echo e(addslashes($doc->document_title)); ?>'; docId = '<?php echo e($doc->document_id); ?>'"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\kuliah\semester6\laravel\sainteku\Modules/DocumentRepository\resources/views/review/index.blade.php ENDPATH**/ ?>