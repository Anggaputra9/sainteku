...
<body class="text-slate-800 bg-white" data-bs-spy="scroll">
    ...
    <nav id="navbar" class="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <ul class="hidden lg:flex items-center gap-1">
                <li><a href="#event"
                        class="px-3 py-2 rounded-lg text-sm font-medium text-slate-600 hover:text-saintek-text transition-colors"><?php echo e(__('messages.event')); ?></a>
                </li>
                <li><a href="#prestasi"
                        class="px-3 py-2 rounded-lg text-sm font-medium text-slate-600 hover:text-saintek-text transition-colors"><?php echo e(__('messages.achievements')); ?></a>
                </li>
                <li><a href="#blog"
                        class="px-3 py-2 rounded-lg text-sm font-medium text-slate-600 hover:text-saintek-text transition-colors"><?php echo e(__('messages.blog')); ?></a>
                </li>
            </ul>
            ...
            <div class="hidden lg:flex items-center gap-3">
                    ...
                    <ul id="langMenu"
                        ...
                        <li>
                            <a href="<?php echo e(route('language.switch', 'id')); ?>"
                                class="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 <?php echo e(session('locale') == 'id' ? 'font-semibold bg-gray-100' : ''); ?>">
                                <span>🇮🇩</span> Indonesia
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('language.switch', 'en')); ?>"
                                class="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 <?php echo e(session('locale') == 'en' ? 'font-semibold bg-gray-100' : ''); ?>">
                                <span>🇬🇧</span> English
                            </a>
                        </li>
                    </ul>
                ...
                <button onclick="document.getElementById('loginModal').classList.remove('hidden')"
                    ...
                    <i class="ri-user-3-line"></i> <?php echo e(__('messages.login')); ?>
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <div class="flex-1 flex flex-col px-5 py-5 gap-4">
            ...
            <ul class="space-y-2">
                <li>
                    <a href="#event"
                        ...
                        <i class="ri-calendar-event-line text-lg"></i> <?php echo e(__('messages.event')); ?>
                ...
                <li>
                    <a href="#prestasi"
                        class="mobile-nav-link flex items-center gap-3 px-4 py-3 bg-slate-50 rounded-xl text-base font-medium text-slate-700 hover:bg-yellow-50 hover:text-saintek-text transition-all">
                        <i class="ri-trophy-line text-lg"></i> <?php echo e(__('messages.achievements')); ?>
                ...
                <li>
                    <a href="#blog"
                        class="mobile-nav-link flex items-center gap-3 px-4 py-3 bg-slate-50 rounded-xl text-base font-medium text-slate-700 hover:bg-yellow-50 hover:text-saintek-text transition-all">
                        <i class="ri-article-line text-lg"></i> <?php echo e(__('messages.blog')); ?>
            ...
            <div class="bg-slate-50 rounded-2xl p-4">
                ...
                <div class="space-y-1">
                    <a href="<?php echo e(route('language.switch', 'id')); ?>"
                        class="flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-700 hover:bg-yellow-50 hover:text-saintek-text transition-all <?php echo e(session('locale') == 'id' ? 'bg-white shadow-sm font-semibold' : ''); ?>">
                        <span>🇮🇩</span> Indonesia
                    </a>
                    <a href="<?php echo e(route('language.switch', 'en')); ?>"
                        class="flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-700 hover:bg-yellow-50 hover:text-saintek-text transition-all <?php echo e(session('locale') == 'en' ? 'bg-white shadow-sm font-semibold' : ''); ?>">
                        <span>🇬🇧</span> English
                    </a>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    <h1 class="text-4xl lg:text-5xl font-semibold leading-tight mb-4 capitalize">
                        <?php echo e(__('messages.faculty_name')); ?>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-12 gap-2">
                            ...
                            <div class="sm:col-span-3">
                                <button
                                    ...
                                    type="button">
                                    <i class="ri-search-2-line"></i> <?php echo e(__('messages.find_button')); ?>
                    ...
                    <ul class="flex flex-wrap items-center gap-2 mt-5 text-sm">
                        <li class="text-red-500 font-semibold flex items-center gap-1"><i
                                class="ri-price-tag-3-line"></i> <?php echo e(__('messages.featured_programs')); ?></li>
                        <li><a href="javascript:void(0)"
                                class="underline text-slate-600 hover:text-saintek-text"><?php echo e(__('messages.informatics')); ?>,</a>
                        </li>
                        <li><a href="javascript:void(0)"
                                class="underline text-slate-600 hover:text-saintek-text"><?php echo e(__('messages.architecture')); ?>,</a>
                        </li>
                        <li><a href="javascript:void(0)"
                                class="underline text-slate-600 hover:text-saintek-text"><?php echo e(__('messages.environmental')); ?>,</a>
                        </li>
                        <li><a href="javascript:void(0)"
                                class="underline text-slate-600 hover:text-saintek-text"><?php echo e(__('messages.library')); ?></a>
                        </li>
                    </ul>
                </div>
    ...
    <section class="py-24 bg-slate-50" id="tentang">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-0.5"><?php echo e(__('messages.dean')); ?></p>
                    ...
                    <div class="absolute top-4 right-4 bg-white rounded-2xl shadow-xl p-3 flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-medium text-slate-800 leading-tight"><span
                                    class="text-slate-700 font-bold">1000+</span> <?php echo e(__('Mahasiswa')); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <h2 class="text-3xl lg:text-4xl font-semibold leading-snug mb-5"><?php echo e(__('messages.about_title')); ?>

                    </h2>
                    <p class="text-slate-500 text-lg mb-4 leading-relaxed"><?php echo e(__('messages.about_desc1')); ?></p>
                    <p class="text-slate-500 text-lg mb-6 leading-relaxed"><?php echo e(__('messages.about_desc2')); ?></p>

                    <div class="space-y-3 mb-8">
                        <div class="flex items-start gap-3">
                            <i class="ri-checkbox-circle-fill text-saintek-text text-2xl shrink-0 mt-0.5"></i>
                            <span class="text-base"><strong><?php echo e(__('messages.about_list1')); ?></strong> (Informatika,
                                Arsitektur, Ilmu Lingkungan, Ilmu Perpustakaan)</span>
                        </div>
                        <div class="flex items-start gap-3">
                            <i class="ri-checkbox-circle-fill text-saintek-text text-2xl shrink-0 mt-0.5"></i>
                            <span class="text-base"><?php echo e(__('messages.about_list2')); ?></span>
                        </div>
                        <div class="flex items-start gap-3">
                            <i class="ri-checkbox-circle-fill text-saintek-text text-2xl shrink-0 mt-0.5"></i>
                            <span class="text-base"><?php echo e(__('messages.about_list3')); ?></span>
                        </div>
                    </div>
                    ...
                    <a href="#!"
                        ...
                        <?php echo e(__('messages.explore_button')); ?> <i class="ri-arrow-right-line"></i>
                    </a>
                </div>
            </div>
        </div>
    ...
    <section class="py-24" id="program-studi">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-14">
                <h2 class="text-3xl lg:text-4xl font-semibold mb-4 text-saintek-text"><?php echo e(__('messages.our_programs')); ?>

                </h2>
                <p class="text-slate-500 text-lg max-w-2xl mx-auto"><?php echo e(__('messages.programs_desc')); ?></p>
            </div>
                ...
                <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        ...
                        <div class="w-20 h-20 bg-yellow-50 rounded-2xl flex items-center justify-center mb-6">
                            <i class="<?php echo e($prog['icon']); ?> text-4xl text-saintek-text"></i>
                        </div>
                        <h4 class="font-semibold text-lg mb-3"><?php echo e(__('messages.' . $prog['key'])); ?></h4>
                        <p class="text-slate-500 text-sm mb-5 leading-relaxed">
                            <?php echo e(__('messages.' . $prog['key'] . '_desc')); ?>

                        </p>
                        <a href="#"
                            class="text-saintek-text font-medium text-sm hover:underline mt-auto flex items-center gap-1"><?php echo e(__('messages.detail')); ?>
    ...
    <section class="bg-saintek-primary py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div>
                    <h4 class="text-black text-2xl lg:text-3xl font-semibold mb-2"><?php echo e(__('messages.cta_title')); ?></h4>
                    <p class="text-black/70 text-lg"><?php echo e(__('messages.cta_desc')); ?></p>
                </div>
                <div class="lg:shrink-0">
                    <a href="#!"
                        ...
                        <?php echo e(__('messages.register_button')); ?>
    ...
    <section class="py-24" id="prestasi">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-14">
                <h2 class="text-3xl lg:text-4xl font-bold mb-4"><?php echo e(__('messages.achievements_title')); ?></h2>
                <p class="text-slate-500 text-lg max-w-2xl mx-auto"><?php echo e(__('messages.achievements_desc')); ?></p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <?php $__currentLoopData = $achievements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card-hover bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100">
                        <div class="relative">
                            <img src="assets/images/small/<?php echo e($item['img']); ?>" class="w-full h-48 object-cover"
                        ...
                        <div class="p-5">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    <p class="font-bold text-sm text-slate-800"><?php echo e(__('messages.' . $item['dept'])); ?></p>
                                    <p class="text-xs text-slate-500"><?php echo e($item['team']); ?></p>
                                </div>
                            </div>
                            <h5 class="font-bold text-base mb-2"><?php echo e($item['title']); ?></h5>
                            <p class="text-slate-500 text-sm mb-4"><?php echo e($item['desc']); ?></p>
                            <div class="flex items-center justify-between">
                                <div class="flex -space-x-2">
                                    <?php $__currentLoopData = $item['avatars']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $av): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <img src="assets/images/users/<?php echo e($av); ?>"
                                            class="w-7 h-7 rounded-full border-2 border-white object-cover" alt="">
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                <a href="#"
                                    class="text-saintek-text text-sm font-medium hover:underline flex items-center gap-1"><?php echo e(__('messages.more')); ?>
    ...
    <section class="py-24" id="fasilitas">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-14">
                <h2 class="text-3xl lg:text-4xl font-bold mb-4"><?php echo e(__('messages.facilities_title')); ?></h2>
                <p class="text-slate-500 text-lg max-w-2xl mx-auto"><?php echo e(__('messages.facilities_desc')); ?></p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <?php $__currentLoopData = $facilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fac): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        ...
                        <img src="assets/images/small/<?php echo e($fac['img']); ?>" class="w-full h-44 object-cover"
                            alt="<?php echo e($fac['title']); ?>">
                        <div class="p-5 flex flex-col flex-1">
                            <h5 class="font-bold text-base mb-1.5"><?php echo e($fac['title']); ?></h5>
                            <p class="text-slate-500 text-sm mb-3"><?php echo e($fac['desc']); ?></p>
                            <span
                                class="mt-auto inline-block bg-yellow-50 text-saintek-text text-xs font-semibold px-3 py-1 rounded-full self-start"><?php echo e(__('messages.' . $fac['badge'])); ?></span>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            ...
            <div class="text-center mt-10">
                <a href="#"
                    ...
                    <?php echo e(__('messages.explore_facilities')); ?>
    ...
    <section class="bg-saintek-primary py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div>
                    <h4 class="text-black text-2xl lg:text-3xl font-semibold mb-2"><?php echo e(__('messages.newsletter_title')); ?>

                    </h4>
                    <p class="text-black/70 text-lg"><?php echo e(__('messages.newsletter_desc')); ?></p>
                </div>
                <div class="lg:shrink-0">
                    <button
                        ...
                        <?php echo e(__('messages.subscribe_button')); ?> <i class="ri-arrow-right-line"></i>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
                <div class="lg:col-span-4">
                    ...
                    <p class="text-slate-400 text-sm mt-4 leading-relaxed"><?php echo e(__('messages.footer_desc')); ?></p>
                    <div class="flex gap-2 mt-5">
                        <?php $__currentLoopData = ['ri-facebook-fill', 'ri-twitter-fill', 'ri-instagram-fill', 'ri-youtube-fill']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="lg:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-8">
                    <div>
                        <h5 class="text-white font-semibold mb-4"><?php echo e(__('messages.quick_links')); ?></h5>
                        <ul class="space-y-2 text-sm text-slate-400">
                            <li><a href="#"
                                    class="hover:text-saintek-primary transition-colors"><?php echo e(__('messages.about_us')); ?></a>
                            </li>
                            <li><a href="#"
                                    class="hover:text-saintek-primary transition-colors"><?php echo e(__('messages.accreditation')); ?></a>
                            </li>
                            <li><a href="#"
                                    class="hover:text-saintek-primary transition-colors"><?php echo e(__('messages.lecturers')); ?></a>
                            </li>
                            <li><a href="#"
                                    class="hover:text-saintek-primary transition-colors"><?php echo e(__('messages.student_affairs')); ?></a>
                            </li>
                            <li><a href="#"
                                    class="hover:text-saintek-primary transition-colors"><?php echo e(__('messages.alumni')); ?></a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <h5 class="text-white font-semibold mb-4"><?php echo e(__('messages.study_programs_footer')); ?></h5>
                        <ul class="space-y-2 text-sm text-slate-400">
                            <li><a href="#"
                                    class="hover:text-saintek-primary transition-colors"><?php echo e(__('messages.informatics')); ?></a>
                            </li>
                            <li><a href="#"
                                    class="hover:text-saintek-primary transition-colors"><?php echo e(__('messages.architecture')); ?></a>
                            </li>
                            <li><a href="#"
                                    class="hover:text-saintek-primary transition-colors"><?php echo e(__('messages.environmental')); ?></a>
                            </li>
                            <li><a href="#"
                                    class="hover:text-saintek-primary transition-colors"><?php echo e(__('messages.library')); ?></a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <h5 class="text-white font-semibold mb-4"><?php echo e(__('messages.help')); ?></h5>
                        <ul class="space-y-2 text-sm text-slate-400">
                            <li><a href="#"
                                    class="hover:text-saintek-primary transition-colors"><?php echo e(__('messages.faq')); ?></a>
                            </li>
                            <li><a href="#"
                                    class="hover:text-saintek-primary transition-colors"><?php echo e(__('messages.contact_us')); ?></a>
                            </li>
                            <li><a href="#"
                                    class="hover:text-saintek-primary transition-colors"><?php echo e(__('messages.sitemap')); ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div
                ...
                <ul class="flex gap-5 text-sm text-slate-500">
                    <li><a href="#"
                            class="hover:text-saintek-primary transition-colors"><?php echo e(__('messages.privacy_policy')); ?></a>
                    </li>
                    <li><a href="#" class="hover:text-saintek-primary transition-colors"><?php echo e(__('messages.terms')); ?></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl overflow-hidden shadow-2xl w-full max-w-4xl flex max-h-[90vh]"
            ...
            <div class="hidden md:flex flex-col items-center justify-center w-5/12 shrink-0 relative overflow-hidden"
                ...
                <div class="text-center relative z-10 px-8 py-6">
                    <img src="<?php echo e(asset('assets/images/uin.png')); ?>" alt="Logo UIN Saizu"
                        class="w-20 h-auto mx-auto mb-4">
                    <h2 class="font-bold text-black text-3xl mb-1">Sainteku</h2>
                    <p class="text-black/80 text-sm"><?php echo e(__('messages.faculty_name')); ?></p>
                    <p class="text-black/80 text-sm mb-6"><?php echo e(__('UIN Prof. K.H. Saifuddin Zuhri Purwokerto')); ?></p>
                    <p class="italic text-black/80 text-sm max-w-xs leading-relaxed">"<?php echo e(__('messages.quote')); ?>"</p>
                </div>
            </div>
            ...
            <div class="flex-1 overflow-y-auto">
                ...
                <div class="md:hidden p-5 text-center border-b border-gray-100 bg-slate-50">
                    ...
                    <p class="text-xs text-slate-500 mt-0.5"><?php echo e(__('messages.faculty_name')); ?></p>
                </div>
                ...
                <div class="p-6 max-w-md mx-auto">
                    ...
                    <div class="mb-6">
                        <h1 class="font-semibold text-2xl text-slate-800 mb-1"><?php echo e(__('messages.sign_in')); ?></h1>
                        <p class="text-sm text-slate-500"><?php echo e(__('messages.enter_credentials')); ?></p>
                    </div>
                    ...
                    <form method="POST" action="/login" id="loginForm">
                        ...
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-slate-700 mb-1.5">
                                <?php echo e(__('messages.email_label')); ?><span class="text-red-500">*</span>
                            </label>
                            <input type="text"
                                ...
                                value="<?php echo e(old('credential')); ?>" required>
                        </div>

                        <div class="mb-4">
                            <label class="block text-sm font-medium text-slate-700 mb-1.5">
                                <?php echo e(__('messages.password_label')); ?><span class="text-red-500">*</span>
                            </label>
                            <div class="relative">
                                <input type="password"
                            ...
                            <small class="text-slate-400 text-xs mt-1 block"><?php echo e(__('messages.password_hint')); ?></small>
                        </div>
    ...
    <div class="hidden fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[1050] flex items-center justify-center p-4"
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6" onclick="event.stopPropagation()">
            <div class="flex items-center justify-between mb-4">
                <h5 class="font-bold text-lg text-slate-800"><?php echo e(__('messages.forgot_password_title')); ?></h5>
            ...
            <p class="text-sm text-slate-500 mb-5"><?php echo e(__('messages.forgot_password_desc')); ?></p>
            ...
            <?php endif; ?>
                ...
                <?php if(session('status')): ?>
                    ...
                    if (fm && fa) {
                        ...
                        fa.innerHTML = '<?php echo e(session("status")); ?>';
                    }
                <?php endif; ?>
