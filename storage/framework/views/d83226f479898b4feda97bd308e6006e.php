    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div x-data="{ openCreate: false }">
                ...
                <?php echo $__env->make('manajemenachievement::modal-create', ['types' => $types, 'levels' => $levels], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
        ...
        <div
            ...
            <div>
                ...
                <p class="text-sm text-red-700 dark:text-red-500">
                    <?php echo e(session('error') ?? 'Gagal menyimpan. Pastikan semua data yang diinput sudah benar dan file tidak melebihi 2MB.'); ?>
        ...
        <div class="flex flex-wrap items-center gap-2 mb-2">
            ...
            <a href="<?php echo e(route('student.achievements.index', ['status' => 'pending'])); ?>"
            ...
            <a href="<?php echo e(route('student.achievements.index', ['status' => 'approved'])); ?>"
            ...
            <a href="<?php echo e(route('student.achievements.index', ['status' => 'rejected'])); ?>"
        ...
        <div x-data="{ openDetail: false, detailUrl: '', detailTitle: '' }">
            <div
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition items-start">
                                <td class="px-6 py-4 align-top">
                                    ...
                                    <div class="text-xs text-gray-400 mt-2">
                                        <i class="fas fa-user mr-1"></i> Diajukan: <?php echo e($item->created_at->format('d/m/Y')); ?>

                                    </div>

                                    
                                    <?php if($item->status == 'rejected' && $item->rejection_note): ?>
                                    <div
                                        ...
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="flex-col">
                                                <span class="block text-[11px] font-bold text-red-700 dark:text-red-400 uppercase tracking-widest mb-1 opacity-80">Catatan Revisi:</span>
                                                <p class="text-sm font-medium text-red-800 dark:text-red-200 leading-relaxed">
                                                    <?php echo e($item->rejection_note); ?>
                                ...
                                <td class="px-6 py-4 align-top">
                                    ...
                                    <div class="text-xs text-gray-500 mt-1">
                                        <i class="fas fa-signal mr-1"></i> <?php echo e($item->level->description ?? '-'); ?>

                                    </div>
                                    <?php if($item->publication_type): ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center align-top">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <a href="<?php echo e(route('student.achievements.show', $item->id)); ?>"
                                        ...
                                        <a href="<?php echo e(route('student.achievements.download', $item->id)); ?>"
                                            class="inline-flex items-center gap-1.5 rounded-lg bg-white px-3 py-2 text-xs font-bold text-gray-700 hover:bg-gray-50 transition shadow-sm border border-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700"
                                            title="Download File">
                                        ...
                                        <?php if($item->status == 'pending'): ?>
                                        <a href="<?php echo e(route('student.achievements.edit', $item->id)); ?>"
                                        ...
                                        <?php if($item->status == 'pending'): ?>
                                        <form method="POST" action="<?php echo e(route('student.achievements.destroy', $item->id)); ?>" class="inline">
                                            <?php echo csrf_field(); ?>
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-16 text-center">
                                    <div class="flex flex-col items-center gap-3 text-gray-400 dark:text-gray-500">
                                        ...
                                        <button @click="openCreate = true"
                                            class="mt-2 inline-flex items-center gap-2 rounded-lg bg-green-600 px-4 py-2 text-sm font-semibold text-white shadow-md hover:bg-green-700 transition">
                                            <i class="fas fa-plus-circle"></i>
                                            Ajukan Prestasi Baru
                                        </button>
                                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Unduhan\sainteku\Modules/ManajemenAchievement\resources/views/index.blade.php ENDPATH**/ ?>