<template x-teleport="#modal-root">
    <div x-data="{ openDelete: false, url: '', courseName: '' }"
        @open-delete-modal.window="openDelete = true; url = $event.detail.url; courseName = $event.detail.name"
        x-show="openDelete"
        ...
        <div @click.away="openDelete = false"
            ...
            <div class="p-6 space-y-5 bg-slate-50 dark:bg-[#0f172a]">
                <p class="text-sm text-gray-600 dark:text-gray-300">
                    Apakah Anda yakin ingin menghapus mata kuliah <span class="font-bold text-gray-900 dark:text-white" x-text="courseName"></span>? Tindakan ini tidak dapat dibatalkan.
                </p>
...
</template><?php /**PATH /mnt/volume_sgp1_1781186006004/projects/sainteku/Modules/MasterData/resources/views/courses/delete-modal.blade.php ENDPATH**/ ?>