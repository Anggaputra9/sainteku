<?php $__env->startSection('content'); ?>
    <div class="mb-8 flex items-center justify-between">
        ...
        <a href="<?php echo e(route('masterdata.units.create')); ?>"
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700/50">
                    <?php $__empty_1 = true; $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="bg-transparent">
                            ...
                            <td class="px-4 py-4 text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($unit->unit_name); ?>
                            ...
                            <td class="px-4 py-4 text-sm">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="<?php echo e(route('masterdata.units.edit', $unit->id)); ?>"
                                    ...
                                    <form method="POST" action="<?php echo e(route('masterdata.units.destroy', $unit->id)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\kuliah\semester6\laravel\sainteku\Modules/MasterData\resources/views/units/index.blade.php ENDPATH**/ ?>