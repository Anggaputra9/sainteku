...
<div x-show="openCreateDosen"
    ...
    <div @click.away="openCreateDosen = false"
        ...
        <form action="<?php echo e(route('dosen.repository.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <select name="tingkat_id"
                        ...
                        <option value="<?php echo e($t->id); ?>" <?php echo e(old('tingkat_id') == $t->id ? 'selected' : ''); ?>>
                            <?php echo e($t->nama); ?>
                ...
                <div>
                    ...
                    <input type="text" name="tanggal" id="datepicker_dosen" required value="<?php echo e(old('tanggal')); ?>"
                        class="w-full rounded-lg border-0 px-4 py-2.5 text-gray-900 ring-1 ring-gray-300 focus:ring-2 focus:ring-blue-500 dark:bg-gray-900 dark:text-white dark:ring-gray-600"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="deskripsi" rows="4"
                        class="w-full rounded-lg border-0 px-4 py-2.5 text-gray-900 ring-1 ring-gray-300 focus:ring-2 focus:ring-blue-500 dark:bg-gray-900 dark:text-white dark:ring-gray-600"
                        placeholder="Deskripsikan prestasi yang diraih..."><?php echo e(old('deskripsi')); ?></textarea>
                </div>
...
</script><?php /**PATH C:\laragon\www\sainteku\Modules/ManajemenAchievement\resources/views/dosen/modal-create.blade.php ENDPATH**/ ?>