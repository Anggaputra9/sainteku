                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition items-start">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center align-top">
                                            <?php if($doc->status == 4): ?>
                                                ...
                                                <?php if(Auth::user()->hasPermission(1, 'U')): ?>
                                                <button
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sainteku\Modules/DocumentRepository\resources/views/index.blade.php ENDPATH**/ ?>