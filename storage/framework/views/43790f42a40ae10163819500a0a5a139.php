...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a href="<?php echo e(route('admin.dosen.pending')); ?>"
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($total ?? $achievements->total()); ?></p>
                    </div>
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-amber-600 dark:text-amber-400"><?php echo e($pending ?? $achievements->where('status','pending')->count()); ?></p>
                    </div>
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-600 dark:text-green-400"><?php echo e($approved ?? $achievements->where('status','approved')->count()); ?></p>
                    </div>
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-red-600 dark:text-red-400"><?php echo e($rejected ?? $achievements->where('status','rejected')->count()); ?></p>
                    </div>
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <a href="<?php echo e(route('admin.dosen.index', ['status' => 'pending'])); ?>"
            ...
            <a href="<?php echo e(route('admin.dosen.index', ['status' => 'approved'])); ?>"
            ...
            <a href="<?php echo e(route('admin.dosen.index', ['status' => 'rejected'])); ?>"
        ...
        <div class="flex flex-wrap items-center gap-4 bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="<?php echo e(route('admin.dosen.index', array_merge(request()->query(), ['tahun' => '']))); ?>"
                ...
                <a href="<?php echo e(route('admin.dosen.index', array_merge(request()->query(), ['tahun' => $tahun]))); ?>"
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center align-top">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="<?php echo e(route('admin.dosen.show', $item->id)); ?>"
                                    ...
                                    <?php if($item->status == 'pending'): ?>
                                    <a href="<?php echo e(route('admin.dosen.show', $item->id)); ?>?action=approve"
                                    ...
                                    <a href="<?php echo e(route('admin.dosen.show', $item->id)); ?>?action=reject"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\kuliah\semester6\laravel\sainteku\Modules/ManajemenAchievement\resources/views/admin/dosen/index.blade.php ENDPATH**/ ?>