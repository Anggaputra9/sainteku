            ...
            <div class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($totalUsers)); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($totalRoles)); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($totalUnits)); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($totalCurricula)); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Kelola pengguna sistem, dosen, dan
                                mahasiswa</p>
                            <div class="mt-4 flex items-center gap-2">
                                <span
                                    class="inline-flex items-center rounded-full bg-blue-50 px-2 py-1 text-xs font-medium text-blue-700 dark:bg-blue-900 dark:text-blue-300">Aktif</span>
                                <span
                                    class="inline-flex items-center rounded-full bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 dark:bg-gray-700 dark:text-gray-300">Terintegrasi
                                    Auth</span>
                            </div>
                        </div>
                ...
                <div class="p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Role & permission untuk akses sistem
                            </p>
                            <div class="mt-4">
                                <span
                                    class="inline-flex items-center rounded-full bg-green-50 px-2 py-1 text-xs font-medium text-green-700 dark:bg-green-900 dark:text-green-300">Default:
                                    Admin, Dekan, Kaprodi, Dosen, Mahasiswa</span>
                            </div>
                        </div>
                    ...
                    <div class="mt-6">
                        <a href="<?php echo e(route('masterdata.roles.index')); ?>"
                            class="inline-flex items-center text-sm font-medium text-green-600 hover:text-green-700 dark:text-green-400">
                            Kelola Role
                            <svg class="ml-1 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7">
                                </path>
                ...
                <div class="p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Struktur fakultas, jurusan, program
                                studi</p>
                            <div class="mt-4">
                                <span
                                    class="inline-flex items-center rounded-full bg-purple-50 px-2 py-1 text-xs font-medium text-purple-700 dark:bg-purple-900 dark:text-purple-300">Contoh:
                                    Saintek, Ushuluddin, dll</span>
                            </div>
                        </div>
                        <div class="rounded-lg bg-purple-50 p-3 dark:bg-purple-900">
                            <svg class="h-6 w-6 text-purple-600 dark:text-purple-300" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5.586M9 9h.008v.008H9V9zm5 0h.008v.008h-.008V9z">
                                </path>
                            </svg>
                        </div>
                    </div>
                ...
                <div class="p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Kurikulum akademik per program studi
                            </p>
                            <div class="mt-4">
                                <span
                                    class="inline-flex items-center rounded-full bg-yellow-50 px-2 py-1 text-xs font-medium text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300">Referensi
                                    untuk modul akademik</span>
                            </div>
                        </div>
                    ...
                    <div class="mt-6">
                        <a href="<?php echo e(route('masterdata.curricula.index')); ?>"
                            class="inline-flex items-center text-sm font-medium text-yellow-600 hover:text-yellow-700 dark:text-yellow-400">
                            Kelola Kurikulum
                            <svg class="ml-1 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7">
                                </path>
                ...
                <div class="p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <div class="mt-4">
                                <span
                                    class="inline-flex items-center rounded-full bg-red-50 px-2 py-1 text-xs font-medium text-red-700 dark:bg-red-900 dark:text-red-300">IJAZAH,
                                    TRANSKRIP, SERTIFIKAT</span>
                            </div>
                        </div>
                    ...
                    <div class="mt-6">
                        <a href="<?php echo e(route('masterdata.categories.index')); ?>"
                            class="inline-flex items-center text-sm font-medium text-red-600 hover:text-red-700 dark:text-red-400">
                            Kelola Kategori
                            <svg class="ml-1 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7">
                                </path>
            ...
            <div
                ...
                <div class="p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo e(config('masterdata.name')); ?>

                            </h3>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Versi
                                <?php echo e(config('masterdata.version') ?? '1.0'); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sainteku\Modules/MasterData\resources/views/index.blade.php ENDPATH**/ ?>