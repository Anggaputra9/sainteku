<?php $__env->startSection('content'); ?>
    <div class="space-y-6" x-data="unitsApp()" x-init="initData()" x-cloak>
        ...
        <?php echo $__env->make('masterdata::units.modal-detail', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('masterdata::units.cpl-delete-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('unitsApp', () => ({
                ...
                async fetchUnits(page = 1) {
                    ...
                    try {
                        const response = await fetch(`<?php echo e(route('masterdata.units.api.data')); ?>?${params.toString()}`, {
                            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /mnt/volume_sgp1_1781186006004/projects/sainteku/Modules/MasterData/resources/views/units/index.blade.php ENDPATH**/ ?>