<div x-data="{ openCreate: false }"
    ...
    <div @click.away="openCreate = false"
        ...
        <div class="shrink-0 flex items-center justify-between border-b border-gray-200 bg-white px-6 py-4 z-20 dark:bg-gray-800 dark:border-gray-700">
            <div>
                <h3 class="text-xl font-bold text-gray-900 dark:text-white">Tambah Unit Baru</h3>
        ...
        <form action="<?php echo e(route('masterdata.units.store')); ?>" method="POST" class="flex flex-col min-h-full">
            <?php echo csrf_field(); ?>
