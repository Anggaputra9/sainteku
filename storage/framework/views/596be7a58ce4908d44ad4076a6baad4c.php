...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10" x-data="{ 
            ...
            fetchBankSoal() {
                this.isLoading = true;
                fetch('<?php echo e(route('monevakademik.tashih.api.banksoal', $course->id)); ?>')
                    .then(res => res.json())
                    .then(data => {
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400 mt-1"><?php echo e($course->id); ?> -
                        <?php echo e($course->course_name); ?></p>
                </div>
                <div>
            ...
            <form id="form-pengajuan" action="<?php echo e(route('monevakademik.tashih.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sainteku\Modules/MonevAkademik\resources/views/tashih/create.blade.php ENDPATH**/ ?>