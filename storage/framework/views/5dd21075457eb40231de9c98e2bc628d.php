            ...
            <div>
                ...
                <nav>
                    <ol class="flex items-center gap-2 text-sm font-medium text-gray-500 dark:text-gray-400 mt-1">
                        ...
                        <li><a href="<?php echo e(route('admin.dosen.index')); ?>" class="hover:text-blue-600">Admin Prestasi Dosen</a> /</li>
                    ...
                    <div class="p-6">
                        <table class="w-full">
                            ...
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                ...
                                <td class="py-3 text-sm text-gray-900 dark:text-white font-semibold"><?php echo e($achievement->judul ?? '-'); ?></td>
                            </tr>
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                ...
                                <td class="py-3 text-sm text-gray-900 dark:text-white">
                                    ...
                                    <?php echo e($achievement->tanggal ? date('d F Y', strtotime($achievement->tanggal)) : '-'); ?>
                            ...
                            <?php if($achievement->kategori && (str_contains($achievement->kategori->nama, 'Jurnal') || str_contains($achievement->kategori->nama, 'Prosiding'))): ?>
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                <td class="py-3 text-sm font-medium text-gray-500 dark:text-gray-400">Jenis Publikasi</td>
                                <td class="py-3 text-sm text-gray-900 dark:text-white"><?php echo e(ucfirst($achievement->jenis_publikasi ?? '-')); ?></td>
                            </tr>
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                <td class="py-3 text-sm font-medium text-gray-500 dark:text-gray-400">Nama Jurnal</td>
                                <td class="py-3 text-sm text-gray-900 dark:text-white"><?php echo e($achievement->nama_jurnal ?? '-'); ?></td>
                            </tr>
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                <td class="py-3 text-sm font-medium text-gray-500 dark:text-gray-400">Volume/Nomor/Halaman</td>
                                <td class="py-3 text-sm text-gray-900 dark:text-white">
                                    Vol. <?php echo e($achievement->volume ?? '-'); ?>, No. <?php echo e($achievement->nomor ?? '-'); ?>, Hal. <?php echo e($achievement->halaman ?? '-'); ?>

                                </td>
                            </tr>
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                <td class="py-3 text-sm font-medium text-gray-500 dark:text-gray-400">ISSN</td>
                                <td class="py-3 text-sm text-gray-900 dark:text-white"><?php echo e($achievement->issn ?? '-'); ?></td>
                            </tr>
                            <?php endif; ?>

                            
                            <?php if($achievement->kategori && (str_contains($achievement->kategori->nama, 'HKI') || str_contains($achievement->kategori->nama, 'Paten'))): ?>
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                <td class="py-3 text-sm font-medium text-gray-500 dark:text-gray-400">Nomor Pendaftaran</td>
                                <td class="py-3 text-sm text-gray-900 dark:text-white"><?php echo e($achievement->nomor_pendaftaran ?? '-'); ?></td>
                            </tr>
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                <td class="py-3 text-sm font-medium text-gray-500 dark:text-gray-400">Status HKI</td>
                                <td class="py-3 text-sm text-gray-900 dark:text-white"><?php echo e($achievement->status_hki ?? '-'); ?></td>
                            </tr>
                            <?php endif; ?>
                            ...
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                ...
                                <td class="py-3 text-sm text-gray-900 dark:text-white"><?php echo e($achievement->isbn ?? '-'); ?></td>
                            </tr>
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                <td class="py-3 text-sm font-medium text-gray-500 dark:text-gray-400">Penerbit</td>
                                <td class="py-3 text-sm text-gray-900 dark:text-white"><?php echo e($achievement->penerbit ?? '-'); ?></td>
                            </tr>
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                <td class="py-3 text-sm font-medium text-gray-500 dark:text-gray-400">Jumlah Halaman</td>
                                <td class="py-3 text-sm text-gray-900 dark:text-white"><?php echo e($achievement->jumlah_halaman ?? '-'); ?></td>
                            </tr>
                            <?php endif; ?>
                            ...
                            <tr class="border-b border-gray-100 dark:border-gray-700">
                                ...
                                <td class="py-3 text-sm text-gray-900 dark:text-white"><?php echo e($achievement->deskripsi); ?></td>
                            </tr>
                            <?php endif; ?>
                            <tr>
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <form action="<?php echo e(route('admin.dosen.approve', $achievement->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <button type="submit"
                        ...
                        <form action="<?php echo e(route('admin.dosen.reject', $achievement->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Unduhan\sainteku\Modules/ManajemenAchievement\resources/views/admin/dosen/show.blade.php ENDPATH**/ ?>