                ...
                <div class="card h-100 p-4">
                    ...
                    <div class="mb-3">
                        <small class="text-muted d-block mb-1">
                            <i class="ri-hashtag me-1"></i> <?php echo e($doc->document_id); ?>

                        </small>
                        <small class="text-muted d-block mb-1">
                            <i class="ri-price-tag-3-line me-1"></i> <?php echo e($doc->type->description ?? 'Umum'); ?>

                        </small>
                        <small class="text-muted d-block">
                            <i class="ri-building-2-line me-1"></i> <?php echo e($doc->unit->unit_name ?? 'Fakultas'); ?>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-auto">
                        <small class="text-muted">
                            <i class="ri-user-line me-1"></i> <?php echo e($doc->creator->name ?? 'Admin'); ?>

                        </small>
                        <small class="text-muted">
                            <i class="ri-calendar-line me-1"></i> <?php echo e($doc->created_at->format('d M Y')); ?>
...
</section><?php /**PATH D:\Unduhan\sainteku\Modules/DocumentRepository\resources/views/public-index.blade.php ENDPATH**/ ?>