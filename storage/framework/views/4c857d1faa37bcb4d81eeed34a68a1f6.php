<div x-data="{ openCreate: false }" @open-create-modal.window="openCreate = true" x-show="openCreate"
    ...
    <div @click.away="openCreate = false"
        ...
        <div class="mb-6 flex items-center justify-between border-b border-gray-100 pb-4 dark:border-gray-700">
            <div>
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Role Baru</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400">Buat hak akses baru untuk sistem <span
                        class="font-semibold text-blue-600 dark:text-blue-400">Sainteku</span></p>
            </div>
            <button type="button" @click="openCreate = false"
                class="inline-flex items-center gap-2 rounded-lg bg-yellow-500 px-4 py-2 text-sm font-semibold text-white shadow-md hover:bg-yellow-600 transition focus:ring-4 focus:ring-orange-200 dark:focus:ring-orange-900">
...
<?php /**PATH D:\Unduhan\sainteku\Modules/MasterData\resources/views/roles/modal-create.blade.php ENDPATH**/ ?>