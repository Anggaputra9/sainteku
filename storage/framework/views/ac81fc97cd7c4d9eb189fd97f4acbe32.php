        ...
        <div class="flex flex-wrap items-center gap-4 bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="<?php echo e(route('admin.dosen.pending')); ?>"
                    class="px-4 py-2 text-sm font-semibold rounded-full transition <?php echo e(!request('tahun') ? 'bg-amber-500 text-white shadow-md' : 'bg-white text-gray-600 border border-gray-200 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-700 dark:hover:bg-gray-700'); ?>">
                    Semua
                </a>
                ...
                <a href="<?php echo e(route('admin.dosen.pending', ['tahun' => $tahun])); ?>"
                    class="px-4 py-2 text-sm font-semibold rounded-full transition <?php echo e(request('tahun') == $tahun ? 'bg-amber-500 text-white shadow-md' : 'bg-white text-gray-600 border border-gray-200 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-700 dark:hover:bg-gray-700'); ?>">
                    <?php echo e($tahun); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Unduhan\sainteku\Modules/ManajemenAchievement\resources/views/admin/dosen/pending.blade.php ENDPATH**/ ?>