    ...
    <div class="space-y-6" x-data="menuManagementApp()" x-init="init()" x-cloak>
                ...
                <div>
                    ...
                    <select x-model="filters.parent" @change="fetchMenus(1)"
                        ...
                        <?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($p->id); ?>"><?php echo e($p->menu_name); ?></option>
                ...
                <div>
                    ...
                    <select x-model="filters.module_id" @change="fetchMenus(1)"
                        ...
                        <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($m->id); ?>"><?php echo e($m->description); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
        ...
        <div x-show="openCreate"
            ...
            <div @click.away="openCreate = false"
                ...
                <form method="POST" action="<?php echo e(route('settings.menu.store')); ?>" class="flex-1 flex flex-col overflow-hidden">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="parent_id"
                                    ...
                                    <?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($p->id); ?>"><?php echo e($p->menu_name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="module_id"
                                    ...
                                    <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($m->id); ?>"><?php echo e($m->description); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div>
    ...
    <script>
        function menuManagementApp() {
            return {
                ...
                menusList: <?php echo json_encode($menus->items(), 15, 512) ?>,
                moduleMap: <?php echo json_encode($moduleMap, 15, 512) ?>,
                pagination: <?php echo json_encode($menus->toArray(), 15, 512) ?>,
                ...
                async fetchMenus(page = 1) {
                    this.isLoading = true;
                    const url = new URL(`<?php echo e(route('settings.menu.index')); ?>`);
                ...
                openDetailModal(menu) {
                    ...
                    this.updateUrl = `<?php echo e(url('settings/menu')); ?>/${menu.id}`;
                    this.deleteUrl = `<?php echo e(url('settings/menu')); ?>/${menu.id}`;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sainteku\resources\views/settings/menu/index.blade.php ENDPATH**/ ?>