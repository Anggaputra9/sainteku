<?php $__env->startSection('content'); ?>
    <div class="space-y-6" x-data="coursesApp()" x-init="initData()"
        ...
        <?php echo $__env->make('masterdata::courses.modal-detail', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('masterdata::courses.cpmk-delete-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            Alpine.data('coursesApp', () => ({
                ...
                initData() {
                    <?php if(session('success')): ?>
                        this.flash('success', <?php echo \Illuminate\Support\Js::from(session('success'))->toHtml() ?>);
                    <?php endif; ?>
                    <?php if(session('error')): ?>
                        this.flash('error', <?php echo \Illuminate\Support\Js::from(session('error'))->toHtml() ?>);
                    <?php endif; ?>
                    this.fetchCourses();
                },
                ...
                async onFakultasFilterChange() {
                    ...
                    try {
                        const response = await fetch(`<?php echo e(route('masterdata.courses.api.prodis')); ?>?fakultas_id=${this.fakultasFilter}`, {
                            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /mnt/volume_sgp1_1781186006004/projects/sainteku/Modules/MasterData/resources/views/courses/index.blade.php ENDPATH**/ ?>