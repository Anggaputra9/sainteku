...
<script>
    window.__SIDEBAR_FLYOUT_MENUS = <?php echo json_encode($flyoutMenusData, 15, 512) ?>;
</script>
                ...
                <div>
                    ...
                    <ul class="flex flex-col gap-1.5">
                        ...
                        <?php $__currentLoopData = ($sidebarMenus ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <li class="relative"
                                x-init="<?php echo e($isActive && $hasChildren ? "if (open === null) open = $i;" : ""); ?>">

                                
                                <?php if($hasChildren): ?>
                                    <button
                                        @click="($store.sidebar.isExpanded || $store.sidebar.isMobileOpen) ? toggle(<?php echo e($i); ?>) : $store.sidebar.showFlyout(<?php echo e($i); ?>, $el)"
                                        @mouseenter="$store.sidebar.showFlyout(<?php echo e($i); ?>, $el)"
                                        ...
                                        :class="(open === <?php echo e($i); ?> || $store.sidebar.flyoutIndex === <?php echo e($i); ?> || <?php echo e($isActive ? 'true' : 'false'); ?>) 
...
</aside><?php /**PATH /mnt/volume_sgp1_1781186006004/projects/sainteku/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>