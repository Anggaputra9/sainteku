        ...
        <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-3 items-end">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Nama, email pengirim, provider..."
                ...
                <div class="flex gap-2">
                    ...
                    <a href="<?php echo e(route('settings.email.index')); ?>" class="flex-1 inline-flex justify-center rounded-xl bg-gray-200 px-5 py-2.5 text-sm font-bold text-gray-700 hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-200">Reset</a>
                </div>
            </form>
        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
                            ...
                            <div>
                                ...
                                <select name="provider" x-model="form.provider" @change="onProviderChange()" required
                                    ...
                                    <?php $__currentLoopData = $providers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key); ?>"><?php echo e($info['label']); ?> <?php if($info['free_limit']): ?> (~<?php echo e($info['free_limit']); ?>/hari free) <?php endif; ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
            ...
            <div @click.away="openDetail = false"
                ...
                <div class="shrink-0 border-t border-gray-200 bg-white px-4 sm:px-6 py-4 dark:bg-[#1e293b] dark:border-gray-700">
                    <div class="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between gap-3">
                        <form :action="`<?php echo e(url('settings/email')); ?>/${detail.id}`" method="POST" onsubmit="return confirm('Hapus konfigurasi ini?')" class="sm:order-1">
                        ...
                        <div class="flex flex-wrap items-center justify-end gap-2 sm:order-2">
                            <form :action="`<?php echo e(url('settings/email')); ?>/${detail.id}/set-default`" method="POST" x-show="!detail.is_default">
                                <?php echo csrf_field(); ?>
                                <button type="submit"
