                            ...
                            <div class="p-4 space-y-3">
                                ...
                                <div x-show="userData.tingkatUtama !== 'kampus' && userData.unitTambahan && userData.unitTambahan.length > 0">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span x-show="userData.unitTambahan && userData.unitTambahan.includes('<?php echo e($unit->id); ?>')"
                                    ...
                                    <div class="grid grid-cols-1 gap-3 rounded-xl bg-white p-4 ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-600 sm:grid-cols-2">
                                        <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="flex items-start gap-3 cursor-pointer group">
                                                <input type="checkbox" name="unit_tambahan[]" value="<?php echo e($unit->id); ?>"
                                                    x-bind:checked="userData.unitTambahan && userData.unitTambahan.includes('<?php echo e($unit->id); ?>')"
                                                    :disabled="!editMode"
                                ...
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="flex items-start gap-3 cursor-pointer group">
                                        <input type="checkbox" name="role_ids[]" value="<?php echo e($role->id); ?>"
                                            x-bind:checked="userData.roles && userData.roles.includes(<?php echo e($role->id); ?>)"
                                            :disabled="!editMode"
                                            class="mt-0.5 h-5 w-5 shrink-0 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-700">
                                        <span class="text-sm leading-snug text-gray-700 dark:text-gray-300 group-hover:text-indigo-600 transition">
                                            <?php echo e($role->role_name); ?>
...
<?php /**PATH C:\laragon\www\sainteku\Modules/MasterData\resources/views/admin/modal-detail.blade.php ENDPATH**/ ?>