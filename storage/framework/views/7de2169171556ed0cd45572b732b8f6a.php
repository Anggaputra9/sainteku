<?php $__env->startSection('content'); ?>
    <div class="mx-auto" x-data="{ 
                    ...
                    editProfileOpen: <?php echo e($errors->hasAny(['name', 'email', 'phone_number', 'birth_date', 'gender', 'avatar', 'bio', 'address']) ? 'true' : 'false'); ?>, 
                    changePasswordOpen: <?php echo e($errors->updatePassword->any() || $errors->hasAny(['current_password', 'password']) ? 'true' : 'false'); ?>,

                    signatureOpen: false,
                    signatureData: '<?php echo e($user->signature ?? ''); ?>',
                    sigMode: 'draw'
                 }" x-cloak>
            ...
            <div class="px-6 pb-8 relative">
                <div class="flex flex-col sm:flex-row sm:items-end gap-5 -mt-12 mb-6">
                    <div
                        ...
                        <img src="<?php echo e($user->avatar ? asset('storage/avatars/' . $user->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&background=random'); ?>"
                            alt="Avatar" class="h-full w-full object-cover">
                    </div>
                    <div class="pb-2">
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($user->name); ?></h3>
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">
                            <?php echo e($user->user_type ?? 'User'); ?> | <?php echo e($user->unit_id ?? 'Unit Belum Diatur'); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                    <div>
                        <span class="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">NIM / NIP /
                            NIK</span>
                        <span
                            class="text-base font-medium text-gray-900 dark:text-gray-100"><?php echo e($user->identity_id ?? '-'); ?></span>
                    </div>
                    <div>
                        <span class="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Email
                            Address</span>
                        <span class="text-base font-medium text-gray-900 dark:text-gray-100"><?php echo e($user->email); ?></span>
                    </div>
                    <div>
                        <span class="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Phone
                            Number</span>
                        <span
                            class="text-base font-medium text-gray-900 dark:text-gray-100"><?php echo e($user->phone_number ?? '-'); ?></span>
                    </div>
                    <div>
                        ...
                        <span class="text-base font-medium text-gray-900 dark:text-gray-100">
                            <?php if($user->gender == 'L'): ?> Laki-laki <?php elseif($user->gender == 'P'): ?> Perempuan <?php else: ?> - <?php endif; ?>
                        </span>
                    </div>
                    <div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="text-sm text-gray-700 dark:text-gray-300 leading-relaxed max-w-3xl">
                            <?php echo e($user->bio ?? 'Belum ada bio singkat.'); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                <div class="md:col-span-2">
                    ...
                    <p class="text-base font-medium text-gray-900 dark:text-gray-100">
                        <?php echo e($user->address ?? 'Alamat belum diatur.'); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <?php if($user->signature): ?>
                        <div
                            ...
                            <img src="<?php echo e($user->signature); ?>" alt="Tanda Tangan" class="h-16 object-contain">
                        </div>
                        <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="mb-2 block text-sm font-semibold text-gray-900 dark:text-white">Tanggal
                                    Lahir</label>
                                <input type="date" name="birth_date" value="<?php echo e(old('birth_date', $user->birth_date)); ?>"
                                    class="w-full rounded-lg border-0 bg-gray-50 py-2.5 px-4 text-sm ring-1 ring-gray-300 focus:ring-2 focus:ring-blue-500 dark:bg-gray-900 dark:text-white dark:ring-gray-600">
                            </div>
                            <div>
                                ...
                                <select name="gender"
                                    ...
                                    <option value="L" <?php echo e(old('gender', $user->gender) == 'L' ? 'selected' : ''); ?>>Laki-laki
                                    </option>
                                    <option value="P" <?php echo e(old('gender', $user->gender) == 'P' ? 'selected' : ''); ?>>Perempuan
                                    </option>
                                </select>
                            </div>
                            <div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="bio" rows="2"
                                    class="w-full rounded-lg border-0 bg-gray-50 py-2.5 px-4 text-sm ring-1 ring-gray-300 focus:ring-2 focus:ring-blue-500 dark:bg-gray-900 dark:text-white dark:ring-gray-600"><?php echo e(old('bio', $user->bio)); ?></textarea>
                            </div>
                            <div class="md:col-span-2">
                                <label class="mb-2 block text-sm font-semibold text-gray-900 dark:text-white">Alamat
                                    Lengkap</label>
                                <textarea name="address" rows="2"
                                    class="w-full rounded-lg border-0 bg-gray-50 py-2.5 px-4 text-sm ring-1 ring-gray-300 focus:ring-2 focus:ring-blue-500 dark:bg-gray-900 dark:text-white dark:ring-gray-600"><?php echo e(old('address', $user->address)); ?></textarea>
                            </div>
                        </div>
        ...
        <template x-teleport="body">
            <div x-show="changePasswordOpen"
                ...
                <div @click.away="changePasswordOpen = false" x-data="{ showPassword: false }"
                    ...
                    <form action="<?php echo e(route('profile.password.update')); ?>" method="POST" class="space-y-5">
                        <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?> <span
                            class="text-xs text-red-500 mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sainteku\resources\views/profile/edit.blade.php ENDPATH**/ ?>