            ...
            <div x-show="mobileUserMenuOpen" @click.outside="mobileUserMenuOpen = false; mobileNotifOpen = false"
                ...
                <div class="px-4 py-3 mb-1 border-b border-gray-100/50 dark:border-gray-700/50">
                    <p class="text-sm font-bold text-gray-900 dark:text-white">
                        <?php echo e(auth()->user()->name ?? 'Guest User'); ?></p>
                    <p class="text-xs text-gray-500 dark:text-gray-400 truncate mt-0.5">
                        <?php echo e(auth()->user()->email ?? 'No Email'); ?></p>
                </div>
                ...
                <button type="button" @click="mobileNotifOpen = !mobileNotifOpen"
                    ...
                    <?php if($mobileUnreadCount > 0): ?>
                        <span
                            class="px-2 py-0.5 text-[10px] font-bold text-white bg-orange-500 rounded-full"><?php echo e($mobileUnreadCount); ?></span>
                    <?php endif; ?>
                </button>
                ...
                <div x-show="mobileNotifOpen" x-transition
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $mobileNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a href="<?php echo e($notification->data['target_url'] ?? '#'); ?>"
                            class="block rounded-lg p-3 text-sm hover:bg-white dark:hover:bg-gray-800">
                            <span
                                class="font-medium text-gray-800 dark:text-white"><?php echo e($notification->data['userName'] ?? 'Sistem'); ?></span>
...
</header><?php /**PATH /mnt/volume_sgp1_1781186006004/projects/sainteku/resources/views/layouts/app-header.blade.php ENDPATH**/ ?>