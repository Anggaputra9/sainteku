                ...
                <div class="shrink-0 border-t border-gray-200 bg-white px-4 sm:px-6 py-4 dark:bg-[#1e293b] dark:border-gray-700">
                    <div class="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between gap-3">
                        ...
                        <div class="flex flex-wrap items-center justify-end gap-2">
                            ...
                            <a :href="`<?php echo e(url('ujian/rooms')); ?>/${detail.room?.uuid}/export-pdf`"
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('examRoomsApp', () => ({
                ...
                async startBatchGrading(forceRegrade = false) {
                    ...
                    try {
                        // Start batch grading
                        const startRes = fetch(`<?php echo e(url('ujian/rooms')); ?>/${this.editingUuid}/grade-all-attempts`, {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'Accept': 'application/json',
                ...
                async pollProgress() {
                    try {
                        const res = await fetch(`<?php echo e(url('ujian/rooms')); ?>/${this.editingUuid}/grading-progress`, {
                            headers: {
                                'Accept': 'application/json',
                                'X-CSRF-TOKEN': this.csrf,
                            },
                ...
                async cancelBatchGrading() {
                    ...
                    try {
                        const res = await fetch(`<?php echo e(url('ujian/rooms')); ?>/${this.editingUuid}/cancel-grading`, {
                            method: 'POST',
                            headers: {
                                'Accept': 'application/json',
                                'X-CSRF-TOKEN': this.csrf,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\kuliah\semester6\laravel\sainteku\Modules/Ujian\resources/views/rooms/index.blade.php ENDPATH**/ ?>