<div x-show="openCreateDosen"
    ...
    <div @click.away="openCreateDosen = false"
        ...
        <form action="<?php echo e(route('dosen.repository.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="deskripsi"
                        rows="3"
                        class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:focus:border-blue-500"
                        placeholder="Deskripsi prestasi..."><?php echo e(old('deskripsi')); ?></textarea>
                </div>
...
</script><?php /**PATH E:\kuliah\semester6\laravel\sainteku\Modules/ManajemenAchievement\resources/views/dosen/modal-create.blade.php ENDPATH**/ ?>