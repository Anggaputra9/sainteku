                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div class="font-medium text-gray-900 dark:text-white"><?php echo e($user->name); ?>

                                                </div>
                                                <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($user->email); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Unduhan\sainteku\Modules/MasterData\resources/views/admin/users.blade.php ENDPATH**/ ?>