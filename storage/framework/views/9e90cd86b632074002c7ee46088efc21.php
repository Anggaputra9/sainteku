        ...
        <div>
            ...
            <div id="signaturePreview" class="mt-3">
                ...
                <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <img src="<?php echo e($user->signature); ?>" alt="Signature" style="max-height: 80px; border: 1px solid #ddd; border-radius: 4px;">
                </div>
                <?php endif; ?>
            </div>
...
</script><?php /**PATH E:\kuliah\semester6\laravel\sainteku\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>