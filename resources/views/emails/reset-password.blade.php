...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Anda menerima email ini karena kami menerima permintaan reset password untuk akun Anda dengan email <strong>{{ $email }}</strong>.</p>
            ...
            <p style="font-size: 12px; word-break: break-all; background: #f5f5f5; padding: 10px;">{{ $resetLink }}</p>
        </div>

        <div class="footer">
            <p>&copy; {{ date('Y') }} Sainteku. All rights reserved.</p>
