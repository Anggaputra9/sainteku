            ...
            <table class="min-w-full text-left text-sm text-gray-600 dark:text-gray-400">
                ...
                <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
                    @forelse($examByPeriod as $period)
                        <tr>
                            <td class="px-4 py-4 font-medium text-gray-900 dark:text-white">{{ $period->name }} &mdash; {{ $period->semester }}</td>
                            <td class="px-4 py-4 text-right font-semibold">{{ number_format($period->total_count) }}</td>
                            <td class="px-4 py-4 text-right text-blue-600 dark:text-blue-400">{{ number_format($period->submitted_count) }}</td>
                            <td class="px-4 py-4 text-right text-emerald-600 dark:text-emerald-400">{{ number_format($period->approved_count) }}</td>
                            <td class="px-4 py-4 text-right text-amber-600 dark:text-amber-400">{{ number_format($period->revised_count) }}</td>
                        </tr>
                    @empty
                        <tr>
