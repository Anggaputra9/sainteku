...
<body data-bs-spy="scroll" data-bs-target="#navbar-example">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item"><a class="nav-link active" href="#event">{{ __('messages.event') }}</a></li>
                    <li class="nav-item"><a class="nav-link" href="#prestasi">{{ __('messages.achievements') }}</a></li>
                    <li class="nav-item"><a class="nav-link" href="#blog">{{ __('messages.blog') }}</a></li>
                </ul>
            </div>
            ...
            <div class="d-none d-lg-flex align-items-center gap-2">
                <div class="dropdown me-2">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a class="dropdown-item language-item {{ session('locale') == 'id' ? 'active-lang' : '' }}"
                                href="{{ route('language.switch', 'id') }}">
                                <span>🇮🇩</span><span>Indonesia</span>
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item language-item {{ session('locale') == 'en' ? 'active-lang' : '' }}"
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <div class="mobile-menu-body">
            <ul class="mobile-nav">
                <li><a href="#event" class="mobile-nav-link">{{ __('messages.event') }}</a></li>
                <li><a href="#prestasi" class="mobile-nav-link">{{ __('messages.achievements') }}</a></li>
                <li><a href="#blog" class="mobile-nav-link">{{ __('messages.blog') }}</a></li>
            </ul>
            <div class="mobile-divider"></div>
            <div class="mobile-lang-section">
                <div class="mobile-lang-title">Language</div>
                <a href="{{ route('language.switch', 'id') }}" class="mobile-lang-link">Indonesia</a>
                <a href="{{ route('language.switch', 'en') }}" class="mobile-lang-link">English</a>
            </div>
            <button class="mobile-login-btn" data-bs-toggle="modal" data-bs-target="#loginModal">
                <i class="ri-user-3-line me-2"></i> {{ __('messages.login') }}
            </button>
        </div>
    </div>
    ...
    <section class="hero-section pb-0" id="hero">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <h1 class="display-4 fw-semibold text-capitalize mb-3 lh-base">{{ __('messages.faculty_name') }}
                    </h1>
                    ...
                    <ul class="list-inline mb-0 mt-4 fs-14">
                        <li class="list-inline-item text-danger fw-semibold"><i
                            ...
                            {{ __('messages.featured_programs') }}</li>
                        <li class="list-inline-item"><a href="javascript:void(0)"
                                class="text-decoration-underline">{{ __('messages.informatics') }},</a></li>
                        <li class="list-inline-item"><a href="javascript:void(0)"
                                class="text-decoration-underline">{{ __('messages.architecture') }},</a></li>
                        <li class="list-inline-item"><a href="javascript:void(0)"
                                class="text-decoration-underline">{{ __('messages.environmental') }},</a></li>
                        <li class="list-inline-item"><a href="javascript:void(0)"
                                class="text-decoration-underline">{{ __('messages.library') }}</a></li>
                    </ul>
                </div>
                <div class="col-lg-5">
                ...
                <div class="col-lg-6 offset-lg-1">
                    ...
                    <div class="vstack gap-3 mb-4">
                        <div class="d-flex align-items-center">
                            ...
                            <span class="fs-5"><strong>{{ __('messages.about_list1') }}</strong> (Informatika,
                    ...
                    <a href="#!" class="btn btn-primary btn-lg px-5 rounded-pill">{{ __('messages.explore_button') }} <i
        ...
        <div class="container">
            <div class="text-center mb-5">
                <h1 class="display-6 mb-3 ff-secondary fw-semibold"><span
                        class="text-primary">{{ __('messages.our_programs') }}</span></h1>
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6">
                    <div class="card h-100 text-center p-4">
                        ...
                        <a href="#" class="link-primary stretched-link">{{ __('messages.detail') }} <i
        ...
        <div class="container py-4">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 text-lg-end mt-4 mt-lg-0">
                    <a href="#!"
                        class="btn btn-danger btn-lg px-5 py-3 rounded-pill">{{ __('messages.register_button') }}</a>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="#" class="text-primary small">{{ __('messages.more') }} <i
                                        class="ri-arrow-right-line"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <a href="#" class="link-primary fw-semibold">{{ __('messages.read_more') }} <i
                                    class="ri-arrow-right-line"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-5 bg-primary">
        <div class="container py-4">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 text-lg-end mt-4 mt-lg-0">
                    <button class="btn btn-danger btn-lg px-5 py-3 rounded-pill">{{ __('messages.subscribe_button') }}
                ...
                <div class="col-sm-6">
                    <div class="text-sm-end mt-3 mt-sm-0">
                        <ul class="list-inline mb-0 footer-list gap-4 fs-13">
                            <li class="list-inline-item"><a href="#">{{ __('messages.privacy_policy') }}</a></li>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-5 d-none d-md-flex flex-column align-items-center justify-content-center"
                        ...
                        <div class="text-center position-relative z-1 px-4 py-3">
                            <img src="{{ asset('assets/images/uin.png') }}" alt="Logo UIN Saizu" class="img-fluid mb-3"
                            ...
                            <p class="mb-3 text-dark" style="font-size: 0.9rem;">
                                {{ __('UIN Prof. K.H. Saifuddin Zuhri Purwokerto') }}</p>
                            <div class="mt-4 pt-2">
                        ...
                        <div class="p-4" style="max-width: 450px; margin: 0 auto;">
                            ...
                            <div class="mb-4">
                                <h1 class="fw-semibold text-gray-800"
                                    style="font-size: 1.8rem; margin-bottom: 0.25rem;">{{ __('messages.sign_in') }}</h1>
                            ...
                            <form method="POST" action="/login" id="loginForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('credential') }}" style="height: 42px;" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted d-block mt-1">{{ __('messages.password_hint') }}</small>
                                </div>
            ...
            <div class="modal-content shadow-lg p-2">
                <div class="modal-header border-0 pb-0 pt-3 px-4">
                    <h5 class="modal-title fw-bold" id="forgotPasswordModalLabel">
                        {{ __('messages.forgot_password_title') }}</h5>
