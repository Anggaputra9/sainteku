                    ...
                    <div class="position-relative text-center mt-5 mt-lg-0">
                        ...
                        <div class="card p-3 shadow-lg inquiry-box mx-auto mb-4" style="max-width: 300px;">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="fs-15 lh-base mb-0">{{ __('Seputar PMB') }}</h5>
                            </div>
                        </div>
    ...
    <section class="section" id="prestasi">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <!-- Prestasi 2-6 (sama polanya, ganti {{ __('messages.more') }} di setiap tombol) -->
                <!-- ... sisanya sama, ganti setiap "Selengkapnya" dengan {{ __('messages.more') }} ... -->
            </div>
    ...
    <section class="section" id="fasilitas">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <!-- ... fasilitas lainnya (ganti badge dengan {{ __('messages.informatics') }}, {{ __('messages.architecture') }}, dll) ... -->
            </div>
    ...
    <section class="section bg-light" id="blog">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <!-- ... blog lainnya (ganti "Baca Selengkapnya" dengan {{ __('messages.read_more') }}) ... -->
            </div>
        </div>
    </section>
