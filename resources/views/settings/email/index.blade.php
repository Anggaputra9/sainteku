                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition">
                                <td class="px-6 py-4">
                                    ...
                                    <div class="text-xs text-gray-500 mt-1">
                                        {{ $row->from_name ?: '—' }} &lt;{{ $row->from_email ?: 'belum diisi' }}&gt;
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    ...
                                    <div class="text-xs text-gray-500 mt-0.5">
                                        ...
                                        @if($row->daily_limit > 0)
                                            · {{ $row->daily_sent }}/{{ $row->daily_limit }}/hari
                                        @endif
                                    </div>
                                </td>
        ...
        function emailSettingsApp() {
            return {
                ...
                resetForm() {
                    ...
                    this.formAction = `{{ route('settings.email.store') }}`;
                },
                ...
                openEditModal(row) {
                    ...
                    this.formAction = `{{ url('settings/email') }}/${row.id}`;
                    this.openEdit = true;
                },

                openTestModal(row) {
                    this.testTarget = row;
                    this.testAction = `{{ url('settings/email') }}/${row.id}/test`;
                    this.openTest = true;
                },
